 ...
 */
final class Version20220322111027 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP created_at, CHANGE text text LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
